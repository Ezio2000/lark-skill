...
def print_usage() -> None:
    usage = [
        "Usage:",
        "  uv run python iconpark_tool.py search --query <text> [--category <Category>] [--limit 8]",
        "  uv run python iconpark_tool.py resolve --name <name|iconType>",
        "  uv run python iconpark_tool.py list-categories",
    ]
