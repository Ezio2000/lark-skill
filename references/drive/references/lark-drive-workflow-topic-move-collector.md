...
本文档实现已注册的主题资料收集 workflow。执行前必须先阅读 [`lark-drive-workflow.md`](lark-drive-workflow.md) 和 [`../../shared/index.md`](../../shared/index.md)，并遵循共享执行协议、Artifact Contract、Workflow Loading、认证和写入确认规则。
...
执行本 workflow 前，必须先阅读 [`../../shared/index.md`](../../shared/index.md)，用于处理身份、认证、权限和写操作确认规则。

按阶段渐进加载其他 skill / 引用文档：

- 目标是 Wiki 或个人文档库：[`../../wiki/index.md`](../../wiki/index.md)
- 需要读取文档内容：[`../../doc/index.md`](../../doc/index.md) 和 [`../../doc/references/lark-doc-fetch.md`](../../doc/references/lark-doc-fetch.md)
- 需要验证 Sheet 内容：[`../../sheets/index.md`](../../sheets/index.md)
