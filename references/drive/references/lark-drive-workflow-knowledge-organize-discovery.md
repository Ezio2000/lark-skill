...
1. Follow [`../../shared/index.md`](../../shared/index.md) for identity, auth, and permission handling.
2. For Wiki / personal library targets, follow [`../../wiki/index.md`](../../wiki/index.md).
...
5. For URL / token inspection, follow [`lark-drive-inspect.md`](lark-drive-inspect.md) and [`../../wiki/references/lark-wiki-node-get.md`](../../wiki/references/lark-wiki-node-get.md).
...
1. Follow [`../../wiki/references/lark-wiki-node-list.md`](../../wiki/references/lark-wiki-node-list.md) traversal semantics.
