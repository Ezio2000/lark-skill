...
1. 按 [`../../shared/index.md`](../../shared/index.md) 处理写操作确认、高风险操作、身份、认证和权限。
...
4. 按 [`../../wiki/references/lark-wiki-node-create.md`](../../wiki/references/lark-wiki-node-create.md) 创建 Wiki 节点。
5. 按 [`../../wiki/references/lark-wiki-move.md`](../../wiki/references/lark-wiki-move.md) 执行 Wiki 移动和 Drive 文档移动到 Wiki。
6. 按 [`../../wiki/references/lark-wiki-move-to-drive.md`](../../wiki/references/lark-wiki-move-to-drive.md) 将 Wiki 节点移出到 Drive 文件夹。
7. 按 [`lark-drive-delete.md`](lark-drive-delete.md) 删除本次 workflow 新建的 Drive 文件夹。
8. 按 [`../../wiki/references/lark-wiki-node-delete.md`](../../wiki/references/lark-wiki-node-delete.md) 删除本次 workflow 新建的 Wiki 节点。
