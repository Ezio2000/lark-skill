...
7. **Application/bot identity + named group history:** If the user says "use application identity / as a bot" and asks to list or read historical messages for a named group, use bot identity for both steps:
   ```bash
