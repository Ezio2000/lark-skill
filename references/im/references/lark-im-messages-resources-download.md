...
A folder itself cannot be downloaded: expand it with `lark-cli im files folder --recursive` first (see [lark-im](../index.md)), then download the files it contains.
...
- [lark-im](../index.md) - all message-related commands
